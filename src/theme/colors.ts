/**
 * These are Tailwind CSS colors.
 * There are too many colors and these are not included in the theme by default
 * to keep the bundle size small. Add necessary colors to the theme when needed.
 *
